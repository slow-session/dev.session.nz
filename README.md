 ...
 * <https://github.com/slow-session/dev.session.nz/compare/gh-pages...master?expand=1>
 ...
 * You should see a page entitled **Open a pull request**
    ...
    * Check the website <https://dev.session.nz/> to make sure the changes are correct.
 ...
 * <https://github.com/slow-session/dev.session.nz/blob/master/LICENSE>
